...
const fourFramePath = path.resolve("public/sprites/wise-idle.png");
const heavyRawPath = path.resolve("public/sprites/.tmp/wise-heavy-raw.png");
...
console.log("OK — 5-frame Wise sprite sheet ready (idle, idle, idle, idle, heavy)");
