...
const inputPath = path.resolve("public/sprites/.tmp/hope-idle-raw.png");
const outputPath = path.resolve("public/sprites/hope-idle.png");

if (!fs.existsSync(inputPath)) {
  console.error(`Missing ${inputPath}. Run: node --env-file=.env.local scripts/gen-hope-idle-sheet.mjs`);
  process.exit(1);
}
...
console.log("OK — sprite-sheet ready");
