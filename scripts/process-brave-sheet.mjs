...
const inputPath = path.resolve("public/sprites/.tmp/brave-idle-raw.png");
const outputPath = path.resolve("public/sprites/brave-idle.png");

if (!fs.existsSync(inputPath)) {
  console.error(`Missing ${inputPath}. Run: node --env-file=.env.local scripts/gen-brave-idle-sheet.mjs`);
  process.exit(1);
}
...
console.log("OK — brave sprite-sheet ready");
