...
const inputPath = path.resolve("public/sprites/.tmp/stress-idle-raw.png");
const outputPath = path.resolve("public/sprites/stress-idle.png");

if (!fs.existsSync(inputPath)) {
  console.error(`Missing ${inputPath}. Run: node --env-file=.env.local scripts/gen-stress-idle-sheet.mjs`);
  process.exit(1);
}
...
console.log("OK — stress (LORD STRES) sprite-sheet ready");
