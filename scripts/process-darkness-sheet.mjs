...
if (!fs.existsSync(inputPath)) {
  console.error(`Missing ${inputPath}. Run: node --env-file=.env.local scripts/gen-darkness-idle-sheet.mjs`);
  process.exit(1);
}
...
console.log("OK — darkness (PANI CIEMNOSC) sprite-sheet ready");
